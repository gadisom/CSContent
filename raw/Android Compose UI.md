...
source: "https://helpingstar.github.io/android/compose_ui/"
author:
  - "[[Park Wooseong]]"
...
> \[!NOTE\] `remember` 를 호출한 composable이 Composition에서 제거되면 해당 객체(`remember` 의 계산 결과) 를 잊어버린다.
...
> \[!NOTE\] `rememberSaveable` 은 activity가 사용자에 의해 완전히 종료(dismissed) 된 경우에는 state를 유지하지 않는다.
